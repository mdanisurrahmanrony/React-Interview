    ...
    render() {
    	...
    	<div id="main-slide" class="cd-hero">
			<ul class="cd-hero-slider">
				<li class="selected">
					<div class="overlay2">
						<img class="" src="assets/images/slider/bg1.jpg" alt=""/>
					</div>
				...
				<li>
					<div class="overlay2">
						<img class="" src="assets/images/slider/bg2.jpg" alt=""/>
					</div>
				...
				<li>
					<div class="overlay2">
						<img class="" src="assets/images/slider/bg3.jpg" alt=""/>
					</div>
			...
			<div class="row">
				<div id="isotope" class="isotope">
						...
						<div class="grid">
							<figure class="effect-oscar">
								...
								<figcaption>
									...
									<a class="view icon-pentagon" data-rel="prettyPhoto" href="assets/images/portfolio/portfolio-bg1.jpg"><i class="fa fa-search"></i></a>            
								</figcaption>			
							</figure>
						</div>
						...
						<div class="grid">
							<figure class="effect-oscar">
								...
								<figcaption>
									...
									<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
									<a class="view icon-pentagon" data-rel="prettyPhoto" href="assets/images/portfolio/portfolio-bg2.jpg"><i class="fa fa-search"></i></a>            
								</figcaption>				
							</figure>
						</div>
					</div>{/* Isotope item end */}
						...
						<div class="grid">
							<figure class="effect-oscar">
								...
								<figcaption>
									<h3>Your Business</h3>
									<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
									<a class="view icon-pentagon" data-rel="prettyPhoto" href="assets/images/portfolio/portfolio-bg3.jpg"><i class="fa fa-search"></i></a>            
								</figcaption>				
							</figure>
						</div>
					</div>{/* Isotope item end */}
					...
					<div class="col-sm-3 wordpress isotope-item">
						<div class="grid">
							<figure class="effect-oscar">
								<img src="assets/images/portfolio/portfolio4.jpg" alt=""/>
								<figcaption>
									<h3>Prego Match</h3>
									<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
									<a class="view icon-pentagon" data-rel="prettyPhoto" href="assets/images/portfolio/portfolio-bg4.html"><i class="fa fa-search"></i></a>            
								</figcaption>					
							</figure>
						</div>
					</div>{/* Isotope item end */}
					...
					<div class="col-sm-3 joomla isotope-item">
						<div class="grid">
							<figure class="effect-oscar">
								<img src="assets/images/portfolio/portfolio5.jpg" alt=""/>
								<figcaption>
									<h3>Fashion Brand</h3>
									<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
									<a class="view icon-pentagon" data-rel="prettyPhoto" href="assets/images/portfolio/portfolio-bg5.html"><i class="fa fa-search"></i></a>            
								</figcaption>					
							</figure>
						</div>
					</div>{/* Isotope item end */}
					...
					<div class="col-sm-3 development isotope-item">
						<div class="grid">
							<figure class="effect-oscar">
								<img src="assets/images/portfolio/portfolio6.jpg" alt=""/>
								<figcaption>
									<h3>The Insidage</h3>
									<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
									<a class="view icon-pentagon" data-rel="prettyPhoto" href="assets/images/portfolio/portfolio-bg1.jpg"><i class="fa fa-search"></i></a>            
					...
					<div class="col-sm-3 development isotope-item">
						<div class="grid">
							<figure class="effect-oscar">
								<img src="assets/images/portfolio/portfolio7.jpg" alt=""/>
								<figcaption>
									<h3>Light Carpet</h3>
									<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
									<a class="view icon-pentagon" data-rel="prettyPhoto" href="assets/images/portfolio/portfolio-bg2.jpg"><i class="fa fa-search"></i></a>            
					...
					<div class="col-sm-3 development isotope-item">
						<div class="grid">
							<figure class="effect-oscar">
								<img src="assets/images/portfolio/portfolio8.jpg" alt=""/>
								<figcaption>
			    ...
			    <div id="testimonial-carousel" class="owl-carousel owl-theme text-center testimonial-slide">
			        <div class="item">
			          	<div class="testimonial-thumb">
			            	<img src="assets/images/team/testimonial1.jpg" alt=""/>>
			          	</div>
			        ...
			        <div class="item">
			          	<div class="testimonial-thumb">
			            	<img src="assets/images/team/testimonial2.jpg" alt=""/>>
			          	</div>
				        <div class="testimonial-content">
				            <p class="testimonial-text">
				              Lorem Ipsum as their default model text, and a search for ‘lorem ipsum’ will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose. Lorem Ipsum is that it as opposed to using.
			        ...
			        <div class="item">
				        <div class="testimonial-thumb">
				            <img src="assets/images/team/testimonial3.jpg" alt=""/>>
				        </div>
			          	<div class="testimonial-content">
				            <p class="testimonial-text">
				              Lorem Ipsum as their default model text, and a search for ‘lorem ipsum’ will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose. Lorem Ipsum is that it as opposed to using.
